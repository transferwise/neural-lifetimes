...
from ...utils.postgres.postgres_ingest import dtypes_from_table
from .sequence_dataset import SequenceDataset


class PostgresSequenceDataset(SequenceDataset):
    def __init__(
        self,
        user: str,
        password: str,
        ...
        """The PostgresSequenceDataset creates a SequenceDataset from a PostgreSQL Database.
        ...
        self.conn = create_engine(f'postgresql+psycopg2://{user}:{password}@{host}:{port}/{database}')
        ...
        result = np.array(self.conn.execute(uid_query).fetchall())
